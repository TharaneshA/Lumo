    ...
    <footer className="py-12 border-t border-border/20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-primary">Lumo</span>
            </Link>
            <p className="mt-2 text-sm text-muted-foreground max-w-xs">
              Transform the way you capture your thoughts with our innovative note-taking platform.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/20 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Lumo. All rights reserved.</p>
